<template>
    <div id="app">
        <nav class="navbar " role="navigation" aria-label="main navigation">
            ...
            <div class="navbar-menu " v-bind:class="{'is-active': menu}">
                <!-- <aside class="menu">
                    ...
                    <ul class="menu-list">
                        <li><a><i class="las la-home"></i> Dashboard</a></li>
                ...
                <div class="navbar-start">
                    ...
                    <ul class="has-background-primary-light">
                        ...
                        <li>
                            <router-link to="/addaadhar" class="navbar-item has-text-primary-dark"><i class="las la-id-card"></i> Add Pan Card </router-link>
                        </li>
                    </ul>
                    <ul class="has-background-primary-light">
                        <li>
        ...
        <router-view v-on:loaded="menuStatus" v-on:userData="updateUserData" />
    </div>
</template>
<script>
export default {
